...
interface ImageSequenceProps extends ViewProps {
    ...
    loop?: boolean;
    /** The width to use for optional downsampling. Both `downsampleWidth` and `downsampleHeight` must be set to a positive number to enable. Default: -1 */
    downsampleWidth?: number;
    /** The height to use for optional downsampling. Both `downsampleWidth` and `downsampleHeight` must be set to a positive number to enable. Default: -1 */
